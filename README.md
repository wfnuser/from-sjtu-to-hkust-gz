...
探路报告保存在被 Git 忽略的 `cache/`，发布用几何保存在 `web/data/inland-reroute-options.geojson`。下面的导出选择“至少减少 10 km 国道”，或“至少减少 3 km 国道且新增里程不超过减少量”的候选；这些路线因未知道路增加仍需复核，原路线始终保留：
