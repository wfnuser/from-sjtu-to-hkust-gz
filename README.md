...
- 公开行程约 1532.5 km；Day 3–15 剩余约 1350.7 km，骑行日均约 103.9 km。Day 3 实际规划保持为海创园亚朵经桐庐捷安特到建德新安江麗枫，约 134.7 km。
- Day 4 改为建德麗枫直达常山东方广场酒店，约 113.8 km。Day 5–15 均不超过 115 km，区间约 88.6–114.2 km，并在 Day 15 抵达香港科技大学（广州）。
- Day 5–8、Day 11、Day 13–14 的酒店有公开洗衣设施证据；Day 9 银坑、Day 10 韩坊、Day 12 船塘的落脚点位置满足里程上限，但自助洗衣必须在订房前电话确认，页面不会将其误标为已确认。
- 左栏只展示 Day 1–15 日卡；点击日卡缩放到当天道路。手机竖屏采用上方地图、下方独立滚动日程面板；桌面使用左侧日程、右侧地图。
